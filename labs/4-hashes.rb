...
us_exchange_rate = bitcoin_data["bpi"]["USD"]["rate_float"]
#puts us_exchange_rate

puts "1 Bitcoin is valued at $#{us_exchange_rate} USD."
bitcoin_value = bitcoin * us_exchange_rate
